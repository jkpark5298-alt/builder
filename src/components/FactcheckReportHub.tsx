...
export function FactcheckReportHub({
  ...
  const stepItems = sortedWorkItems.filter(
    (v) => factcheckWorkStep(v) === inputStep
  );
      ...
      <section id="fc-input" className="space-y-5 scroll-mt-24">
        ...
        >
          {(
            ...
            const count = sortedWorkItems.filter(
